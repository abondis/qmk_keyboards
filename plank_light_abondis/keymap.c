...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    LT(_LOWER, KC_ESC), KC_TAB, _______, KC_LGUI,   KC_BSPC, KC_RALT, KC_LCTL, KC_SPC,  KC_LALT,   KC_MINS, KC_QUOT, LT(_RAISE, KC_ENT)
),
...
KC_BTN1, _______, RESET  , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS 
),
